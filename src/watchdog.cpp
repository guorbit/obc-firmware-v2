...
namespace iwdg
{
    ...
    constexpr uint32_t prescaler = IWDG_PRESCALER_256; // previously IWDG_PRESCALER_32 but bit too often
    constexpr uint32_t reload_value = 9999U;            // (99 + 1) * 32 / 32000 = 100 ms
